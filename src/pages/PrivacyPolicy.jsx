...
const PrivacyPolicy = () => {
  return (
    <>
      <div className="mx-8 md:mx-20 py-10">
        <article className="prose prose-sm max-w-none">
          <p>
            ポケカル（以下、「当方」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
        </article>
        ...
        <article className="prose prose-sm">
          ...
          <span>
            ...
            <a
              ...
              rel="noreferrer"
            >
              https://twitter.com/Arisato_Asumi
            </a>
          </span>
          <br></br>
          <p>以上</p>
